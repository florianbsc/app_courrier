    ...
    <div class="container-fluid">
        <div class="col-sm-6 col-12 mb-4 mb-sm-0" style="display: flex">
            ...
            <span class="text-muted text-sm" style="margin-left: 10px; margin-top: 1.5%">
                Nombre de d'utilisateurs : {{ count($users) }}
            </span>
        </div>
        <div class="col-sm-6 col-12 mb-2 mb-sm-0" style="display: flex;margin-top:5px;">
            ...
            <form method="POST" action="{{ route('liste_user_recherche') }}" style="display:flex">
                    ...
                    <tbody>
                        @foreach($users as $user)
                            <tr>
                                ...
                                <ul class="nav">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('delete_user', ['id_user' => $user->id_user])}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('edit_user', ['id_user' => $user->id_user])}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
